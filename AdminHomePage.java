...
public class AdminHomePage extends JFrame implements ActionListener {
    ...
    AdminHomePage(String adminname, String admin_id,int login_id, String username) {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Hospital/icons/home 2.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (command.equals("Add Doctor")) {
            ...
            new CheckMyProfile(admin_id2,login__id).setVisible(true);
        }else if(command.equals("Change Password")){
            new ChangeMyPassword(admin_id2,login__id).setVisible(true);
        }
