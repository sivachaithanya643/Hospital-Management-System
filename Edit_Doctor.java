...
public class Edit_Doctor extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            try {
                ConnectionClass obj1 = new ConnectionClass();
                String q2 = "update doctor set name='" + name + "', dob='" + dob + "', address='" + address + "', phone='" + phone + "', email='" + email + "', city='" + city + "', gender='" + gender + "', blood='" + blood + "', age='" + age + "', clinic_no='" + clinic + "', joining_date='" + jod + "', specialization='" + splz + "' where username='" + username + "'";
