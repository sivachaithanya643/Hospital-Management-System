...
public class Add_Patient extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            Random r = new Random();
            String pat_id = String.format("%05d", r.nextInt(100000));

            try {
                ConnectionClass obj = new ConnectionClass();
                String q = "INSERT INTO patient VALUES ('" + pat_id + "', '" + name + "', '" + username + "', '" + password + "', '" + email + "', '" + fname + "', '" + phone + "', '" + marital_status + "', '" + city + "', '" + gender + "', '" + blood + "', '" + age + "', '" + dob + "', '" + disease + "', '" + address+"')";
